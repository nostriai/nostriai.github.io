  ...
  <header :class="alpine.header.position || 'left'">
    ...
    <div class="logo">
      <NuxtLink v-if="alpine.header.logo" to="/">
        ...
        <NuxtImg class="dark-img" :src="alpine.header.logo.pathDark" :alt="alpine.header.logo.alt" width="130" height="30" />
        <NuxtImg class="light-img" :src="alpine.header.logo.path" :alt="alpine.header.logo.alt" width="130" height="30" />
      </NuxtLink>
